...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnShiva.setOnClickListener(v -> showDeity(
                "भगवान शिव",
                "भगवान शिव को हिंदू परंपरा में महादेव के नाम से जाना जाता है। " +
                "उनसे जुड़ी अनेक कथाएँ और तीर्थस्थल भारत में प्रसिद्ध हैं।"
        ));

        btnRam.setOnClickListener(v -> showDeity(
                "भगवान श्री राम",
                "श्री राम को मर्यादा पुरुषोत्तम कहा जाता है। " +
                "रामायण में उनके जीवन, आदर्श और धर्म के बारे में वर्णन मिलता है।"
        ));
    ...
    private void showRssInfo() {
        ...
        infoText.setText(
                ...
                "इस basic version में किसी paid API key की जरूरत नहीं है।"
        );
    }
}
